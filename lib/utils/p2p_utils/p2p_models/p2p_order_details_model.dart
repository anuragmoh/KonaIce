...
P2POrderDetailsModel p2POrderDetailsModelFromJson(String str) =>
    P2POrderDetailsModel.fromJson(json.decode(str));

String p2POrderDetailsModelToJson(P2POrderDetailsModel data) =>
...
class P2POrderDetailsModel {
  ...
  factory P2POrderDetailsModel.fromJson(Map<String, dynamic> json) =>
      P2POrderDetailsModel(
        tip: json["tip"],
        ...
        orderRequestModel:
            PlaceOrderRequestModel.fromJson(json["orderRequestModel"]),
      );
