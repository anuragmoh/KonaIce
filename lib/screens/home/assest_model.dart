...
AssetsResponseModel assetsModelResponseFromJson(String str) => AssetsResponseModel.fromJson(json.decode(str));

String assetsModelResponseToJson(AssetsResponseModel data) => json.encode(data.toJson());
...
class AssetsResponseModel {
  ...
  factory AssetsResponseModel.fromJson(Map<String, dynamic> json) => AssetsResponseModel(
    count: json["count"],
    limit: json["limit"],
    offset: json["offset"],
...
final atedByValues = EnumValues({
  "0830e2157fcf45849b5f51cd4b0ecebd": AtedBy.THE_0830_E2157_FCF45849_B5_F51_CD4_B0_ECEBD
});

enum FranchiseId { THE_2_DA4_CA9843_AE491994_CAC47_D28_D0_AA8_D }

final franchiseIdValues = EnumValues({
  "2da4ca9843ae491994cac47d28d0aa8d": FranchiseId.THE_2_DA4_CA9843_AE491994_CAC47_D28_D0_AA8_D
});

enum ImageFileId { EMPTY, THE_63_F496_E99_A7_B4726_B40_F9_E7_ABE8_DB5_D7, THE_680529_C11_F924_CDDB16_EF0_C1_BCC882_FE }

final imageFileIdValues = EnumValues({
  "": ImageFileId.EMPTY,
  "63f496e99a7b4726b40f9e7abe8db5d7": ImageFileId.THE_63_F496_E99_A7_B4726_B40_F9_E7_ABE8_DB5_D7,
  "680529c11f924cddb16ef0c1bcc882fe": ImageFileId.THE_680529_C11_F924_CDDB16_EF0_C1_BCC882_FE
});
