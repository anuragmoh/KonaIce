...
class _CustomerViewScreenState extends State<CustomerViewScreen> {
            ...
            child: Column(
              children: [
                ...
                componentCustomerDetails(
                    'Nicholas Gibson', '+1 546 546 356', 'nic.gibson@gmail.com'),
                const Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        ListView.builder(
            ...
            return orderItemView('Kollectible',2,23.0,index.isEven ? true : false);
        }),

        DottedLine(height:2.0,color:getMaterialColor(AppColors.textColor1)),
        componentBill(),
      ],
    ),
  );

  Widget orderItemView(String itemTitle,int itemCount,double itemAmount,bool isSubItem)=> Column(
  ...
  Widget componentBill()=>Column(
    children: [
      ...
      Divider(thickness: 1,color: getMaterialColor(AppColors.textColor1),),
  ...
  Widget componentBottomWidget()=>Padding(
    ...
    child: Image.asset(AssetsConstants.switchAccount,width: 30.0,height: 30.0),
  );
