...
class _PaymentScreenState extends State<PaymentScreen>
        ...
        child: SizedBox(
          ...
          child: Row(
              ...
              children: [
                                  ...
                                  child: Center(
                                    child: Padding(
                                      padding: const EdgeInsets.only(
                                          left: 4.0, bottom: 2.0),
                                      child: TextField(
                                        maxLength: TextFieldLengthConstant
                                            .amountReceived,
                ...
                // Button
                Visibility(
                  visible: paymentModeType == PaymentModeConstants.creditCard
                      ? false
                      : true,
                  child: buttonWidget(
                      isPaymentDone == true
  ...
  void receivedDataFromP2P(P2PDataModel response) {
    if (response.action == CustomerActionConst.paymentModeSelected) {
      ...
      P2PCardDetailsModel cardDetailsModel =
          p2PCardDetailsModelFromJson(response.data);
      getTokenCall(cardDetailsModel.cardNumber!, cardDetailsModel.cardCvc!,
          cardDetailsModel.cardExpiryMonth!, cardDetailsModel.cardExpiryYear!);
    }
  }
