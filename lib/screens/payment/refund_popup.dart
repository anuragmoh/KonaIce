...
class RefundPopup extends StatefulWidget {
  ...
  RefundPopup({required this.amount, Key? key})
      : super(key: key);
...
class _RefundPopup extends State<RefundPopup> {
  ...
  void initState() {
    super.initState();
    totalAmoutController = TextEditingController(text: widget.amount.toString());
  }
  ...
  onTapConfirmButton() {
    ...
    if(isTotalAmoutValid==true){
      DialogHelper.confirmationDialog(context, onConfirmTapYes, onConfirmTapNo,StringConstants.confirmAmountMessage);
    }
  }
  onTapCloseButton() {
