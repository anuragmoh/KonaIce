...
class FinixResponseDto {
  ...
  factory FinixResponseDto.fromJson(Map<String, dynamic> json) =>
      FinixResponseDto(
        finixSaleResponse:
            FinixSaleResponse.fromJson(json["finixSaleResponse"]),
        finixSaleReceipt: FinixSaleReceipt.fromJson(json["finixSaleReceipt"]),
        tipAmount: json["tipAmount"],
        finixCaptureResponse:
            FinixCaptureResponse.fromJson(json["finixCaptureResponseDto"]),
      );
...
class FinixCaptureResponse {
  ...
  factory FinixCaptureResponse.fromJson(Map<String, dynamic> json) =>
      FinixCaptureResponse(
...
class FinixSaleReceipt {
  ...
  factory FinixSaleReceipt.fromJson(Map<String, dynamic> json) =>
      FinixSaleReceipt(
...
class FinixSaleResponse {
  ...
  factory FinixSaleResponse.fromJson(Map<String, dynamic> json) =>
      FinixSaleResponse(
        transferId: json["transferId"],
        updated: json["updated"].toDouble(),
        amount: json["amount"],
