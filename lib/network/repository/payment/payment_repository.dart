...
class PaymentRepository {
  ...
  Future<StripTokenResponseModel> getStripeToken(
      dynamic stripTokenRequestModel) {
    return paymentBaseClient
        .post(UrlConstants.paymentGetToken, stripTokenRequestModel)
        .then((value) {
  ...
  Future<StripePaymentMethodRequestModel> getPaymentMethod(dynamic response) {
    return paymentBaseClient
        .post(UrlConstants.paymentMethod, response)
        .then((value) {
