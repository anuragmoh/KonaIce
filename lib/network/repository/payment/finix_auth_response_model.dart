...
FinixAuthResponseModel finixAuthResponseModelFromJson(String str) => FinixAuthResponseModel.fromJson(json.decode(str));

String finixAuthResponseModelToJson(FinixAuthResponseModel data) => json.encode(data.toJson());
...
class AuthorizationResponseModel {
  ...
  factory AuthorizationResponseModel.fromJson(Map<String, dynamic> json) => AuthorizationResponseModel(
    finixAuthorizationResponse: FinixAuthorizationResponse.fromJson(json["finixAuthorizationResponse"]),
    finixAuthorizationReceipt: FinixAuthorizationReceipt.fromJson(json["finixAuthorizationReceipt"]),
  );
...
class FinixAuthorizationReceipt {
  ...
  factory FinixAuthorizationReceipt.fromJson(Map<String, dynamic> json) => FinixAuthorizationReceipt(
...
class FinixAuthorizationResponse {
  ...
  factory FinixAuthorizationResponse.fromJson(Map<String, dynamic> json) => FinixAuthorizationResponse(
    ...
    resourceTags: FinixAuthorizationResponseResourceTags.fromJson(json["resourceTags"]),
    emv: json["emv"],
...
class FinixAuthorizationResponseResourceTags {
  ...
  factory FinixAuthorizationResponseResourceTags.fromJson(Map<String, dynamic> json) => FinixAuthorizationResponseResourceTags(
...
class FinixCaptureResponse {
  ...
  factory FinixCaptureResponse.fromJson(Map<String, dynamic> json) => FinixCaptureResponse(
    ...
    created: json["created"].toDouble(),
    transferId: json["transferId"],
    resourceTags: FinixCaptureResponseResourceTags.fromJson(json["resourceTags"]),
    transferState: json["transferState"],
  );
...
class FinixCaptureResponseResourceTags {
  ...
  factory FinixCaptureResponseResourceTags.fromJson(Map<String, dynamic> json) => FinixCaptureResponseResourceTags(
  );
