...
class SyncEventMenu {
  ...
  factory SyncEventMenu.fromJson(Map<String, dynamic> json) => SyncEventMenu(
        pOsSyncEventDataDtoList: List<POsSyncEventDataDtoList>.from(
            json["pOSSyncEventDataDtoList"]
                .map((x) => POsSyncEventDataDtoList.fromJson(x))),
        pOsSyncItemCategoryDataDtoList:
            List<POsSyncItemCategoryDataDtoList>.from(
                json["pOSSyncItemCategoryDataDtoList"]
                    .map((x) => POsSyncItemCategoryDataDtoList.fromJson(x))),
        pOsSyncEventItemDataDtoList: List<POsSyncEventItemDataDtoList>.from(
            json["pOSSyncEventItemDataDtoList"]
                .map((x) => POsSyncEventItemDataDtoList.fromJson(x))),
        pOsSyncEventItemExtrasDataDtoList:
            List<POsSyncEventItemExtrasDataDtoList>.from(
                json["pOSSyncEventItemExtrasDataDtoList"]
                    .map((x) => POsSyncEventItemExtrasDataDtoList.fromJson(x))),
        pOsSyncDeletedEventDataDtoList: List<POsSyncEventDataDtoList>.from(
            (json["pOSSyncDeletedEventDataDtoList"] ?? [])
                .map((x) => POsSyncEventDataDtoList.fromJson(x))),
        pOsSyncDeletedItemCategoryDataDtoList:
            List<POsSyncItemCategoryDataDtoList>.from(
                (json["pOSSyncDeletedItemCategoryDataDtoList"] ?? [])
                    .map((x) => POsSyncItemCategoryDataDtoList.fromJson(x))),
        pOsSyncDeletedEventItemDataDtoList:
            List<POsSyncEventItemDataDtoList>.from(
                (json["pOSSyncDeletedEventItemDataDtoList"] ?? [])
                    .map((x) => POsSyncEventItemDataDtoList.fromJson(x))),
        pOsSyncDeletedEventItemExtrasDataDtoList:
            List<POsSyncEventItemExtrasDataDtoList>.from(
                (json["pOSSyncDeletedEventItemExtrasDataDtoList"] ?? [])
                    .map((x) => POsSyncEventItemExtrasDataDtoList.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "pOSSyncEventDataDtoList":
            List<dynamic>.from(pOsSyncEventDataDtoList.map((x) => x.toJson())),
        "pOSSyncItemCategoryDataDtoList": List<dynamic>.from(
            pOsSyncItemCategoryDataDtoList.map((x) => x.toJson())),
        "pOSSyncEventItemDataDtoList": List<dynamic>.from(
            pOsSyncEventItemDataDtoList.map((x) => x.toJson())),
        "pOSSyncEventItemExtrasDataDtoList": List<dynamic>.from(
            pOsSyncEventItemExtrasDataDtoList.map((x) => x.toJson())),
        "pOSSyncDeletedEventDataDtoList": List<dynamic>.from(
            pOsSyncDeletedEventDataDtoList.map((x) => x.toJson())),
        "pOSSyncDeletedItemCategoryDataDtoList": List<dynamic>.from(
            pOsSyncDeletedItemCategoryDataDtoList.map((x) => x.toJson())),
        "pOSSyncDeletedEventItemDataDtoList": List<dynamic>.from(
            pOsSyncDeletedEventItemDataDtoList.map((x) => x.toJson())),
        "pOSSyncDeletedEventItemExtrasDataDtoList": List<dynamic>.from(
            pOsSyncDeletedEventItemExtrasDataDtoList.map((x) => x.toJson())),
      };
}
...
class POsSyncEventDataDtoList {
  ...
  factory POsSyncEventDataDtoList.fromJson(Map<String, dynamic> json) =>
      POsSyncEventDataDtoList(
...
class POsSyncEventItemDataDtoList {
  ...
  factory POsSyncEventItemDataDtoList.fromJson(Map<String, dynamic> json) =>
      POsSyncEventItemDataDtoList(
...
class POsSyncEventItemExtrasDataDtoList {
  ...
  factory POsSyncEventItemExtrasDataDtoList.fromJson(
...
class POsSyncItemCategoryDataDtoList {
  ...
  factory POsSyncItemCategoryDataDtoList.fromJson(Map<String, dynamic> json) =>
      POsSyncItemCategoryDataDtoList(
        eventId: json["eventId"],
...
class SyncEventRequestModel {
  ...
  factory SyncEventRequestModel.fromJson(Map<String, dynamic> json) =>
      SyncEventRequestModel(
